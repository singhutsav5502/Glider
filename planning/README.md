...
`vendor_ref/` — mirrored `.proto` schemas (Cursor's `agent.v1` / `aiserver.v1`)
kept for offline reading; not a build dependency. See
`internal/cursorrpc/THIRD_PARTY.md` for the actual vendored Go module.
