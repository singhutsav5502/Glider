...
// CursorCustomModelPrefix is the loophole documented by the Copilot-for-Cursor
// proxy: Cursor hijacks known model names to api2.cursor.sh; a custom prefix
// forces Override Base URL / OpenAI-compat routing instead.
// See: https://dev.to/jacksonkasi/how-i-reverse-engineered-cursor-ide-to-run-on-github-copilot-a-proxy-architecture-deep-dive-2jin
...
//
// Proven necessary by jacksonkasi/copilot-for-cursor when Agent tools hit a
// custom OpenAI Base URL. Best-effort: on failure returns the original body.
//
